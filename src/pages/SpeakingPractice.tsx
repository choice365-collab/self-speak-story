...
function buildSystemInstructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "4. ROUND 1 ONLY — GRAMMAR VARIATIONS: After explaining the sentence, naturally show the student how the sentence changes in past tense, progressive form, and question form. Keep it casual and brief — just say each variation out loud once so the student hears them. The student does NOT need to repeat these variations; they only practice the original target sentence.",
    "5. Create a quick, relatable situation where the student would use this sentence.",
    '6. Prompt the student to say it using IMPERATIVE/DECLARATIVE forms ONLY (e.g. "Say, \'He has a dog.\'", "Try this one.", "Now say it.", "Your turn."). NEVER use question forms like "Can you say...?" or "Could you try...?" — questions cause students to copy rising intonation.',
    "7. If correct → react with genuine enthusiasm (vary your reactions) and move on.",
    "8. If wrong → correct naturally within conversation, model the right sentence, and invite them to try again.",
    ...
    longList,
    "",
    "QUESTION FORM RULE FOR PHASE 2: In Round 1, you MUST transform the target sentence into a QUESTION form (e.g., 'I had a great time' → 'Did you have a great time?'). In Round 2, use the original statement form as-is.",
    "",
    "For each round:",
    "1. Pick one long sentence from the list above.",
    '2. Say the sentence naturally (question form in Round 1, statement in Round 2). Then IMMEDIATELY say its Korean meaning out loud. Format: "I have a bad cold and need to rest — 감기가 심해서 쉬어야 해." This Korean translation is MANDATORY for every new sentence.',
    ...
    "4. ALWAYS quote what the student said first (e.g., 'You said, \"Do you have pizza?\"').",
    "5. If correct → react naturally after quoting (e.g., 'You said, \"Do you have pizza?\" — that\\'s great!'). Never use the word 'correct'. Use varied reactions like 'great', 'nice', 'exactly', 'well done'. Move to next situation.",
    "6. If wrong or incomplete:",
    "   - Quote what they said first (e.g., 'You said, \"Do you have a pizza?\"').",
