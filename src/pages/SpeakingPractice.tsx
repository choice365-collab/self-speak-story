...
function buildSystemInstructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "4. Prompt the student to try saying it (vary your phrasing each time).",
    "5. If correct → react with genuine enthusiasm (vary your reactions) and move on.",
    "6. If wrong → correct naturally within conversation, model the right sentence, and invite them to try again.",
