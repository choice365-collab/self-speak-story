...
function buildPhase1Instructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "",
    "── [TARGET] MARKER RULE ──",
    "Whenever you say a TARGET SENTENCE (the sentence student must learn/repeat), prefix it with [TARGET].",
    "This includes the base sentence AND every tense variation (past, question, progressive).",
    "Example: '[TARGET] I have a plan.' or '[TARGET] Did you have a plan?'",
    "Do NOT use [TARGET] for instructions, praise, corrections, or explanations — ONLY for the model sentence itself.",
    "",
    buildToneBlock(),
    "",
...
function buildPhase2Instructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "── [TARGET] MARKER RULE ──",
    "Whenever you say a TARGET SENTENCE (the sentence student must learn/repeat), prefix it with [TARGET].",
    "This includes the base sentence AND the question form variation.",
    "Example: '[TARGET] I have a big plan for the weekend.'",
    "Do NOT use [TARGET] for instructions, praise, corrections, or explanations — ONLY for the model sentence itself.",
    "",
    buildToneBlock(),
    "",
...
function buildPhase3Instructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "",
    "── [TARGET] MARKER RULE ──",
    "When you model the FINAL CORRECT sentence for the student to repeat, prefix it with [TARGET].",
    "Example: '[TARGET] I want to go to the park.'",
    "Do NOT use [TARGET] for instructions, hints, Korean explanations, or praise — ONLY for the final model sentence.",
    "",
