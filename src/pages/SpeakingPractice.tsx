...
function buildSystemInstructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    "",
    "GOAL: The student uses \"" + verb.base_verb + "\" (or any natural expression) in a situation YOU create.",
    "",
    "CRITICAL PHASE 3 RULES:",
    "• You AUTONOMOUSLY invent a fun, child-friendly situation. Do NOT rely on any pre-written seeds.",
