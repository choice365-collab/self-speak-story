...
function buildSystemInstructions(verb: VerbData, difficultyLevel: string, speechSpeed: string, koreanHintMode: boolean): string {
  ...
  return [
    ...
    "",
    "PHASE 1 — GUIDED (All situations EXCEPT the last one):",
    ...
    "",
    "PHASE 2 — FINAL CHALLENGE (ONLY the very last situation):",
    "- Tell the student: 'OK, now it's YOUR turn! Let's see if you can make a sentence on your own!'",
    "- Present the situation scenario, but do NOT model the target sentence.",
    "- Ask the student: 'How would you say that in English?' or 'Can you try to make a sentence using " + verb.base_verb + "?'",
    ...
    "- When the student successfully says the sentence correctly, say 'PRACTICE COMPLETE!' to end the lesson.",
    "",
