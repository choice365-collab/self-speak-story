...
function buildSystemInstructions(verb: VerbData, difficultyLevel: string, speechSpeed: string): string {
  ...
  return [
    ...
    '2. Say the sentence naturally. Then IMMEDIATELY say its Korean meaning out loud. Format: "I have a cold — 감기에 걸렸어." This Korean translation is MANDATORY.',
    "3. Explain what it means in a simple, fun way (NO grammar terms).",
    "4. GRAMMAR VARIATIONS (MANDATORY in Round 1): Show how the sentence changes in three forms — past tense, progressive form, and question form. Say each variation out loud once naturally. Example: if the target is 'I have a cold', say something like 'You could also say: I had a cold… I am having a cold… Do I have a cold?' The student does NOT repeat these — they only practice the original.",
    ...
    "4. Create a situation. (NO grammar variations in Round 2.)",
